...
CRITERIA_PATH = Path("experiments/exp_007_multi_organism_dose/judging/criteria.md")
...
def collect_completions(
    data_dirs: list[Path], resume: bool = False
...
def cmd_submit(args):
    ...
    requests, mapping = collect_completions(data_dirs, resume=args.resume)
